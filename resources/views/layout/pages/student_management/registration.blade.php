                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="AdmissionId">
                                </div>
                                <!-- /.form-group -->
                            </div>
                            <!-- /.col -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Admissions">
                                </div>
                            </div>
                            <!-- /.form-group -->
                        </div>
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label>MA Adress</label>
                                    <input type="text" class="form-control" placeholder="MA Adress">
                                </div>
                            </div>
                            <!-- /.form-group -->
                        </div>
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label>Foffice Number</label>
                                    <input type="text" class="form-control" placeholder="Foffice Number">
                                </div>
                            </div>
                            <!-- /.form-group -->
                        </div>
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label>Studied Com</label>
                                    <input type="text" class="form-control" placeholder="Studied Com">
                                </div>
                                <!-- /.form-group -->
                            </div>
                            <!-- /.col -->
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Student Fee">
                                </div>
                                <!-- /.form-group -->
                            </div>
                            <!-- /.col -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Refrence">
                                </div>
                            </div>
                            <!-- /.form-group -->
                        </div>
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Discount Fee">
                                </div>
                                <!-- /.form-group -->
                            </div>
                            <!-- /.col -->
